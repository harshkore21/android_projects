...
import com.example.devconnects.databinding.ReelDgBinding
...
class ReelAdapter (var context: Context, var reelList: ArrayList<Reel>) : RecyclerView.Adapter<ReelAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Picasso.get().load(reelList.get(position).profileList).placeholder(R.drawable.account1).into(holder.binding.profileImage)
